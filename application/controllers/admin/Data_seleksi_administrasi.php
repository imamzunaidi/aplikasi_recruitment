...
class Data_seleksi_administrasi extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data = array(
            'title' => 'Data Seleksi Administrasi',
            'data_applay' => $this->M_applay_lowongan->get_all(),
        );
        $this->templates->admin('v_data_seleksi_administrasi', $data);
    }
    ...
    public function update(){
		...
		$this->email->subject('Pengumuman Seleksi Administrasi');
        ...
        if($this->input->post('status_lamaran') == 'tidak lolos'){
            ...
            $data_appaly = [
                'status_lamaran' => 'seleksi administrasi',
            ];
        ...
        $this->flash_message->success('Update', 'data-seleksi-administrasi');
    }
    ...
    public function email(){
        ...
        $config['smtp_host'] = 'smtp.mailtrap.io';
        $config['smtp_port'] = 2525;
        $config['smtp_user'] = 'wifqihana3@gmail.com';
        $config['smtp_pass'] = 'WifqiHana123#';
        $config['crlf'] = "\r\n";
        $config['newline'] = "\r\n";
