      ...
      <div class="card table-responsive">
        <div class="card-body ">
            <table class = "table table-striped">
                ...
                <tbody>
                    <?php $no = 1; foreach($data_applay as $value){ ?>
                        <tr>
                            <td><?= $no++?></td>
...
<div class="modal fade" id="Update<?= $value->id_applay_lowongan?>">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">Seleksi Administrasi</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <form action="<?= base_url('admin/data_seleksi_administrasi/update')?>" method="post">
