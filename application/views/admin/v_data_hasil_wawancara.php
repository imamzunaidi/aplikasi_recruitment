      ...
      <div class="card table-responsive">
        ...
        <div class="card-body ">
            <table class = "table table-striped">
                ...
                <tbody>
                    <?php $no = 1; foreach($data_hasil_wawancara as $value){ ?>
                        <tr>
                            <td><?= $no++?></td>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('admin/Data_hasil_wawancara/detail/'.$value->id_pelamar.'/'.$value->id_applay_lowongan)?>" class="btn btn-info btn-sm"><i class="fas fa-eye"></i></a>
