            ...
            <div class="footer-content">
              <div class="footer-head">
                ...
                <div class="footer-icons">
                  <ul>
                    <li>
                      <a href="<?= base_url('login')?>"><i class="fa fa-users"></i> </a>
                    </li>
                    <br>
                    <a href="<?= base_url('login')?>"></a>Login Admin
          ...
          <div class="col-md-8 col-sm-8 col-xs-12">
            <div class="footer-content">
              <div class="footer-head">
                <h4>information</h4>
                <p>
                SMK Al-Muhtadin Bekasi adalah sebuah sekolah menengah kejuruan yang 
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="copyright text-center">
              <p>
                &copy; Copyright <strong>E-REC</strong>. All Rights Reserved
              </p>
            </div>
            <div class="credits">
            </div>
